# parser-sandbox Specification

## Purpose
Defense-in-depth hardening of the unprivileged parser worker: a seccomp network-deny filter self-applied before any input is read (a parser RCE cannot reach the network), plus decompression-bomb limits and supervisor-specified cgroup limits.
## Requirements
