...
The fleet's server side: it receives agent telemetry, VERIFIES signatures before persisting, and keeps
verified and self-asserted records distinguishable, because unverified telemetry is not evidence. On top
of that aggregate it runs the singleton work under a leader lease — peer-UEBA, correlation into
incidents, retention purge, risk publication — and serves the operator's read surfaces, cases with
four-eyes closure, legal holds, and best-effort alert delivery. The aggregate is a derived view with an
enforced retention window; it is NOT the evidentiary ledger.
...
<!-- restored from 2026-07-21-add-control-plane -->
...
<!-- restored from 2026-07-21-add-signed-telemetry-ingest -->
...
<!-- restored from 2026-07-21-add-view-audit-controlplane -->
...
<!-- restored from 2026-07-22-siem12-notify-off-ingest -->
...
<!-- restored from 2026-07-21-fleet-alert-search -->
...
<!-- restored from 2026-07-21-fleet-case-workflow -->
...
<!-- restored from 2026-07-22-siem11a-correlation-correctness -->
...
<!-- restored from 2026-07-21-gateway-risk-publish -->
...
<!-- restored from 2026-07-21-hon2-case-legal-hold -->
...
<!-- restored from 2026-07-21-incident-case-linking -->
...
<!-- restored from 2026-07-21-operator-read-api -->
...
<!-- restored from 2026-07-21-persist-telemetry-seq -->
...
<!-- restored from 2026-07-21-sec4-no-silent-telemetry-loss -->
...
<!-- restored from 2026-07-23-sec8-limit-param-validation -->
...
<!-- restored from 2026-07-22-siem1-mount-events -->
...
<!-- restored from 2026-07-22-siem6b-alert-lifecycle-schema -->
...
<!-- restored from 2026-07-21-wire-peer-ueba-fleet -->
...
<!-- restored from 2026-07-21-wire-retention-purge -->
...
<!-- restored from 2026-07-22-plat2-jetstream-telemetry-durability -->
...
<!-- restored from 2026-07-22-plat2b-active-passive-ha -->
...
<!-- restored from 2026-07-23-soar1-incident-notify-wiring -->
...
<!-- restored from 2026-07-22-siem5b-prune-validate-ueba -->
...
<!-- restored from 2026-07-22-siem8-notify-robustness -->
...
<!-- restored from 2026-07-22-siem8b-webhook-replay-protection -->
...
<!-- from console-6-keyset-pagination -->
...
<!-- from console-6b-alert-incident-pagination -->
