# retention-reporting Specification

## Purpose
A queryable record of what retention purged, when, how much, and under which policy (SIEM-10) — the
compliance evidence for the retention guarantee (D81/D20). Recording is best-effort over the purge
