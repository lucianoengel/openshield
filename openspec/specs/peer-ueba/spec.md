...
Behavioural risk from comparison rather than from a threshold: a subject is scored against its PEERS,
with the subject under test excluded from its own baseline and old activity decayed so a steady subject
does not drift into anomaly. It runs server-side over the verified fleet stream, is off by default, and
NEVER controls agents. Risk aggregates per entity across every domain, reaches every alias of that
entity, and never lowers a signal another domain already raised.
...
<!-- restored from 2026-07-21-add-peer-ueba -->
...
<!-- restored from 2026-07-21-measure-harden-detection -->
...
<!-- restored from 2026-07-21-sec10-persist-context-version -->
...
<!-- restored from 2026-07-22-siem5-persist-ueba-baselines -->
