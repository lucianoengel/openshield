...
- **T-009** Audit ledger: Postgres hash chain + forward integrity (D12)  _(~8.0h · deps: T-003)_
...
- **T-015** Dogfood on owner fleet, measure operability  _(~6.0h · deps: T-007, T-008, T-010, T-011, T-012, T-013)_
...
- **T-016** Trivial wiring proof - one event end to end, stubs only  _(~2.0h · deps: T-005)_
...
- **T-017** Agent identity + enrollment (A6)  _(~4.0h · deps: T-006)_
...
- **T-018** Tamper-detection: heartbeat / dead-man's-switch (D16)  _(~4.0h · deps: T-009)_
...
---
_agent-hours: 0.0 done · 89.0 remaining (21 tickets)_
